    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">体检管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="医生名称" class="input" v-if="tableName=='jiaoshi'">
                            <el-input v-model="ruleForm.jiaoshiName" autocomplete="off" placeholder="医生名称"  />
                        </el-form-item>
                        <el-form-item label="医生手机号" class="input" v-if="tableName=='jiaoshi'">
                            <el-input v-model="ruleForm.jiaoshiPhone" autocomplete="off" placeholder="医生手机号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="jiaoshiPhotoFlag">
                            </el-form-item>
                            <el-form-item label="医生头像" class="input" v-if="tableName=='jiaoshi'">
                                    <file-upload
                                        tip="点击上传医生头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="医生邮箱" class="input" v-if="tableName=='jiaoshi'">
                            <el-input v-model="ruleForm.jiaoshiEmail" autocomplete="off" placeholder="医生邮箱"  />
                        </el-form-item>
                        <!--

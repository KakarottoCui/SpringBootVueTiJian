        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='jiankangyizhan'">
                    <el-form-item class="select" v-if="type!='info'"  label="体检站" prop="jiankangyizhanId">
                        <el-select v-model="ruleForm.jiankangyizhanId" :disabled="ro.jiankangyizhanId" filterable placeholder="请选择体检站" @change="jiankangyizhanChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='jiankangyizhan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="体检站名称" prop="jiankangyizhanName">
                        <el-input v-model="jiankangyizhanForm.jiankangyizhanName"
                                  placeholder="体检站名称" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiankangyizhan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="体检站地址" prop="jiankangyizhanAddress">
                        <el-input v-model="jiankangyizhanForm.jiankangyizhanAddress"
                                  placeholder="体检站地址" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiankangyizhan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="体检站类型" prop="jiankangyizhanValue">
                        <el-input v-model="jiankangyizhanForm.jiankangyizhanValue"
                                  placeholder="体检站类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiankangyizhan' ">
                    <el-form-item class="input" v-if="type!='info'"  label="体检站热度" prop="jiankangyizhanClicknum">
                        <el-input v-model="jiankangyizhanForm.jiankangyizhanClicknum"
                                  placeholder="体检站热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="体检站热度" prop="jiankangyizhanClicknum">
                            <el-input v-model="ruleForm.jiankangyizhanClicknum"
                                      placeholder="体检站热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   jiankangyizhanId: [
                              { required: true, message: '体检站不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }

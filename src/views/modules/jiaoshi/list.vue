        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '医生名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.jiaoshiName" placeholder="医生名称" clearable></el-input>
                     </el-form-item>
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column label="医生名称" prop="jiaoshiName" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.jiaoshiName}}
                        </template>
                    </el-table-column>
                    <el-table-column label="医生手机号" prop="jiaoshiPhone" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">
                            {{scope.row.jiaoshiPhone}}
                        </template>
                    </el-table-column>
                    <el-table-column label="医生头像" prop="jiaoshiPhoto" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center" width="200">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="医生邮箱" prop="jiaoshiEmail" :sortable="contents.tableSortable" :align="contents.tableAlign" header-align="center">
                        <template slot-scope="scope">

    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生名称" prop="jiaoshiName">
                       <el-input v-model="ruleForm.jiaoshiName"
                                 placeholder="医生名称" clearable  :readonly="ro.jiaoshiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医生名称" prop="jiaoshiName">
                           <el-input v-model="ruleForm.jiaoshiName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生手机号" prop="jiaoshiPhone">
                       <el-input v-model="ruleForm.jiaoshiPhone"
                                 placeholder="医生手机号" clearable  :readonly="ro.jiaoshiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医生手机号" prop="jiaoshiPhone">
                           <el-input v-model="ruleForm.jiaoshiPhone"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiaoshiPhoto" label="医生头像" prop="jiaoshiPhoto">
                        <file-upload
                            tip="点击上传医生头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoshiPhoto" label="医生头像" prop="jiaoshiPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生邮箱" prop="jiaoshiEmail">
                       <el-input v-model="ruleForm.jiaoshiEmail"
                                 placeholder="医生邮箱" clearable  :readonly="ro.jiaoshiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医生邮箱" prop="jiaoshiEmail">
                           <el-input v-model="ruleForm.jiaoshiEmail"
